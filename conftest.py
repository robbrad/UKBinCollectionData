...
def hass():
    ...
    # Core-library tests do not install Home Assistant.  Import it only for the
    # dedicated component suite, which runs inside the exact HA container.
    ...
    # Home Assistant's async_get_entry is a synchronous lookup despite its name.
