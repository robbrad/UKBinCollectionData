    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        for collection in collection_days:
            ...
            if date_element and date_element.has_attr("datetime"):
                ...
                collection_date = datetime.strptime(date_str, "%d-%m-%Y").strftime(
                    date_format
                )
            else:
                raise ValueError(
                    "Could not find a valid date element for collection day."
                )
            ...
            if type_element:
                ...
                raise ValueError(
                    "Could not find a valid type element for collection day."
                )
