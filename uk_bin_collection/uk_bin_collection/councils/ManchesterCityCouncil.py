...
class CouncilClass(AbstractGetBinDataClass):
    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        response = s.post('https://www.manchester.gov.uk/bincollections', headers=postcode_request_header,
        ...
        response = s.post('https://www.manchester.gov.uk/bincollections', headers=uprn_request_headers,
