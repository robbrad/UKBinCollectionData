...
class CouncilClass(AbstractGetBinDataClass):
    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        response = s.get('https://my.rbwm.gov.uk/special/find-your-collection-dates', headers=headers)
        ...
        response = s.post('https://my.rbwm.gov.uk/special/address-selector-collection-dates', headers=headers,
                          data=data)
        ...
        response = s.get(api_url + href_url.split("?")[1], params=params, headers=headers)
