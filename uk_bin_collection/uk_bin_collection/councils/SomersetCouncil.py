...
class CouncilClass(AbstractGetBinDataClass):
    ...
    def parse_data(self, page: str, **kwargs) -> dict:
        ...
        with requests.Session() as s:
            ...
            payload_protected = soup.select_one('input[id="pPageItemsProtected"]').get('value')
            ...
            for key in merged_list.keys():
                ...
                elif key in ["p_flow_id", "p_flow_step_id", "p_instance", "p_page_submission_id", "p_request",
                             "p_reload_on_submit"]:
                    other_list[key] = val
                else:
            ...
            json_builder = {'pageItems': {'itemsToSubmit': new_list, 'protected': payload_protected, 'rowVersion': '',
                                          'formRegionChecksums': []},
                            'salt': payload_salt}
            ...
            s.post('https://iweb.itouchvision.com/portal/wwv_flow.accept', data=other_list)
            ...
            json_builder = {'pageItems': {'itemsToSubmit': new_list, 'protected': payload_protected,
            ...
            for item in soup.select('.t-MediaList-item'):
                for value in item.select('.t-MediaList-body'):
                    dict_data = {
                        ...
                        "collectionDate": datetime.strptime(value.select('.t-MediaList-desc')[0].get_text(strip=True),
