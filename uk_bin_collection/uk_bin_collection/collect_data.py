...
def main(args):
    ...
    parser.add_argument("URL", type=str, help="URL to parse - should be wrapped in double quotes")
    parser.add_argument("-p", "--postcode", type=str, help="Postcode to parse - should include a space and be wrapped in "
                                                        "double-quotes", required=False)
    ...
    return client_code(council_module.CouncilClass(), address_url, postcode=postcode, paon=paon, uprn=uprn)
